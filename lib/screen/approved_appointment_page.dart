...
class ApprovedAppointmentPage extends StatefulWidget {
  @override
  _ApprovedAppointmentPageState createState() =>
      _ApprovedAppointmentPageState();
}

class _ApprovedAppointmentPageState extends State<ApprovedAppointmentPage> {
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Text(
                                                                _listTransaction[index]
                                                                        ...
                                                                        0
                                                                    ? 'Waiting'
                                                                    : _listTransaction[index]['jobStatus'] ==
                                                                            1
                                                                        ? 'On Process'
                                                                        : _listTransaction[index]['jobStatus'] ==
                                                                                2
