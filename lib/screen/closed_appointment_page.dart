...
class ClosedAppointmentPage extends StatefulWidget {
  @override
  _ClosedAppointmentPageState createState() => _ClosedAppointmentPageState();
}

class _ClosedAppointmentPageState extends State<ClosedAppointmentPage> {
  ...
  getBooking() async {
    ...
    try {
      var _result = await _transactionService.getListTransaction('2');
